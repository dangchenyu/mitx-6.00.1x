...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while times >0:
        ...
        letterlast.append(letter)
        letter=input('Please guess a letter:')
        guessInLowerCase = letter.lower()
        if guessInLowerCase in letterlast:
        ...
        if guessInLowerCase in secretWord:
            ...
            times-=1
        print('-----------')
        if len(getGuessedWord(secretWord, lettersGuessed))==long and isWordGuessed(secretWord, lettersGuessed):
            break
