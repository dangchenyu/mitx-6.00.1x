...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(lefthand)!=0:
        # Display the hand
        print('Current Hand:',end = " ")
        displayHand(lefthand)
        # Ask user for input
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                # Update the hand 
                 lefthand=updateHand(lefthand, word)

    # Game is over (user entered a '.' or ran out of letters), so tell user the total score
    return print('Run out of letters. Total score: '+str(total_score)+' points.')
    ...
    while word!='e':
        ...
        if word=='n':
            ...
            if onemore=={}:
                ...
                playHand(onemore, wordList, HAND_SIZE)
                word=input('Enter n to deal a new hand, r to replay the last hand, or e to end game:')
        else: 
